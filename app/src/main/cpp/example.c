...
//访问Java非静态方法
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_accessMethod(JNIEnv *env, jobject jobj) {
    //得到jclass
    jclass jcla = (*env)->GetObjectClass(env, jobj);
    //得到jmethodID
...
//访问Java中静态方法
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_accessStaticMethod(JNIEnv *env, jobject jobj) {
    jclass jcla = (*env)->GetObjectClass(env, jobj);
...
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_accessConstructor(JNIEnv *env, jobject jobj) {
    //得到类Date对应的jclass
...
//调用父类的方法
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_accessNonvirtualMethod(JNIEnv *env, jobject jobj) {
    //得到MainActivity对应的jclass
    jclass jcla = (*env)->GetObjectClass(env, jobj);
    //得到animal属性对应的jfieldID
    jfieldID jfid = (*env)->GetFieldID(env, jcla, "animal",
...
//传入数组
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_putArray(JNIEnv *env, jobject jobj, jintArray arr_) {
...
Java_com_itkluo_ndk_MainActivity_getArray(JNIEnv *env, jobject jobj, jint arrLength) {
    //创建一个指定大小的数组
...
//模拟：循环创建数组
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_localRef(JNIEnv *env, jobject jobj) {
    int i = 0;
    for (; i < 5; i++) {
        //创建Date对象
        jclass  jcla = (*env)->FindClass(env, "java/util/Date");
...
jstring jstr;
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_createGlobalRef(JNIEnv *env, jobject jobj) {
...
//获得
JNIEXPORT jstring JNICALL
Java_com_itkluo_ndk_MainActivity_getGlobalRef(JNIEnv *env, jobject jobj) {
    return jstr;
}

//释放
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_deleteGlobalRef(JNIEnv *env, jobject jobj) {
...
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_exception(JNIEnv *env, jobject jobj) {
    jclass jcla = (*env)->GetObjectClass(env, jobj);
...
//缓存策略
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_cache(JNIEnv *env, jobject jobj) {
    jclass jcla = (*env)->GetObjectClass(env, jobj);
    //局部静态变量，作用域当然是函数中
...
jmethodID globalMID;
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_MainActivity_initIDs(JNIEnv *env, jclass jcla) {
