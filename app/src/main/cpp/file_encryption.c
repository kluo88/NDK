...
Java_com_itkluo_ndk_Encryptor_cryption(JNIEnv *env, jclass jcla, jstring normal_path_jstr, jstring crypt_path_jstr) {
//jstring --> char*
...
//解密
JNIEXPORT void JNICALL
Java_com_itkluo_ndk_Encryptor_decryption(JNIEnv *env, jclass jcla, jstring crypt_path_jstr, jstring decrypt_path_jstr) {
//jstring --> char*
char *crypt_path = (*env)->GetStringUTFChars(env, crypt_path_jstr, NULL);
